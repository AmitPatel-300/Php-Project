...
<tbody>
    ...
    if ($result->num_rows>0) {
        while ($rows=$result->fetch_assoc()) {
            ...
            echo '<td>
            <!-- Icons -->
            <a href="editCategory.php?id='.$rows['category_id'].'&name='.$rows['cname'].' " title="Edit">
            <img src="resources/images/icons/pencil.png" alt="Edit" /></a>
            <a href="deleteCategory.php?id='.$rows['category_id'].'" title="Delete">
...
or "column-right" on fieldsets to divide the form into columns -->
    ...
    <p>
            ...
            type="text" id="medium-input" name="cname" /> 
            <br/><small>Add category name</small> 
    </p>

    
    <p>
        <input class="button" type="submit" value="submit" name="cate" />
    </p>
